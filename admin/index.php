...
$query = "SELECT * FROM home_setup,aboutus_setup,admin_users";
  ...
  <div class="container-fluid">
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="sidebar-sticky pt-3">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link" href="?editcharacters=true">
                <span data-feather="archive"></span>
                Edit Characters
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="?editsettings=true">
                <span data-feather="archive"></span>
                Edit Settings
              </a>
            </li>
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        } else if (isset($_GET['editcharacters'])) {
          include('php/characters.php');
